...
void volumeOfACylinder(void){
  double height = 7;
  double radius = 4;
  double volumn = 3.14159265359 * radius * radius * height;
  printf("The cylinder with height %0.1fcm and radius %0.1fcm has a volume of %0.2fcm^3.\n", height, radius, volumn);
}
